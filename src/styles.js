...
export const useNavbarStyles = {
  appBar: {
    ...
    background: "radial-gradient(circle at bottom, #e7dcb1 , #d39e73)",
  },
  section: {
    alignItems: "center",
    display: "flex",
...
export const useLoginPageStyles = {
  signUpCard: {
    maxWidth: "348px",
    padding: "16px 40px",
    marginBottom: "10px",
...
export const useSignUpPageStyles = {
  card: { maxWidth: "348px", padding: "16px 40px", marginBottom: "10px" },
  section: {
    display: "grid",
    placeItems: "center",
    height: "100vh",
...
export const useUserCardStyles = (avatarSize = 44) => {
  return {
    avatar: {
      width: avatarSize,
      height: avatarSize,
...
export const useFeedSideSuggestionsStyles = {
  article: {
    margin: "12px 0",
    gridTemplateColumns: "minmax(auto, 600px)",
    justifyContent: "center",
...
export const useFollowSuggestionsStyles = {
  container: {
    maxWidth: "100vw",
  },
  slide: {
...
export const useFollowButtonStyles = (side) => {
  return {
    button: {
      height: "30px !important",
      width: "75px !important",
      padding: "0px 16px !important",
      marginTop: side ? "0px !important" : "10px !important",
...
export const useLoadingScreenStyles = {
  section: {
    height: "100%",
    position: "absolute",
    width: "100%",
...
/* Notification List component: /components/NotificationList.js */
export const useNotificationListStyles = {
  listContainer: {
...
export const useOptionsDialogStyles = {
  dialogScrollPaper: {
...
export const useExploreSuggestionsStyles = {
  container: {
    width: "90%",
  },
  typography: {
...
export const useExploreGridStyles = {
  article: {
    display: "grid",
...
export const useGridPostStyles = {
  image: {
    width: "100%",
    userSelect: "none",
  },
...
export const useMorePostsFromUserStyles = {
  article: {
    display: "grid",
    gridTemplateColumns: "minmax(auto, 935px)",
    width: "100vw",
...
export const useFeedPostSkeletonStyles = {
  container: {
    display: "flex",
    flexDirection: "column",
    overflow: "hidden",
...
export const usePostSkeletonStyles = {
  container: {
    overflow: "hidden",
    position: "relative",
    borderRadius: "3px",
...
export const useEditProfilePageStyles = () => {
  return {
    section: {
      display: "grid",
      gridAutoFlow: "column",
...
export const useProfilePictureStyles = (size = 150, isOwner) => {
  return {
    person: {
      color: "#ffffff",
      height: size,
...
export const useProfileTabsStyles = () => {
...
export const useAddPostDialogStyles = () => {
  return {
    appBar: {
      position: "relative",
...
export const useEstablishmentStyles = {
  image: {
    width: "100%",
  },
  container: {},
...
export const usePostsAtEstablishment = {
  article: {
    display: "grid",
    gridTemplateColumns: "minmax(auto, 935px)",
    width: "100vw",
...
export const useEstablishmentSkeletonStyles = {
  container: {
    overflow: "hidden",
    position: "relative",
    border: "1px solid rgba(var(--b6a,219,219,219),1)",
